## Script to fetch annotations of coiled-coil domains from Uniprot. Results in TSV file with Uniprot IDs and Uniprot residue ranges for coiled-coil domains for all Uniprot IDs in the HumanPPI dataset
